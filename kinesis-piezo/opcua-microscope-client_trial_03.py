...
from asyncua.server.history_sql import HistorySQLite  # Import the HistorySQLite class
...
async def main():
    ...
    sqlite_history = HistorySQLite("test.db")  # Provide a desired database file name
