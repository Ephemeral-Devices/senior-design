	...
	class Program
	{
		static void Main(string[] args)
		{
			...
			try
			{
				...
				MotorConfiguration motorSettings = motor.GetMotorConfiguration(serialNo, DeviceConfiguration.DeviceSettingsUseOptionType.UseFileSettings);
		...
		public static void TestPotentiometerParameters(TCubeDCServo device)
		{
			try
			{
				...
				realPotentiometerParameters.Positions[0].Velocity += 0.5m;
				realPotentiometerParameters.Positions[1].Velocity += 0.5m;
				realPotentiometerParameters.Positions[2].Velocity += 0.5m;
				realPotentiometerParameters.Positions[3].Velocity += 0.5m;
